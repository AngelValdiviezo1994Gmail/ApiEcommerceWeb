using ApiEcommerceWeb.Application;
using ApiEcommerceWeb.Persistence;
using Microsoft.OpenApi.Models;
using ApiEcommerceWeb.Extensions;
using FluentValidation.AspNetCore;
using ServiceExtAplication = ApiEcommerceWeb.Application.ServiceExtensions;
